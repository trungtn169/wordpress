...
{
	if (!empty($block['attrs']['className']) && str_contains($block['attrs']['className'], 'class_to_check')) {
		// echo '<pre>';
		// var_dump($block);
		// echo '</pre>';
	}
...
{
	if (!empty($block['attrs']['className']) && str_contains($block['attrs']['className'], 'post_navigation')) {
